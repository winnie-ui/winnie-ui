...
import radiusExampleCss from "./_components/radius-example.css?raw";
import { RadiusExample } from "./_components/radius-example.tsx";
import radiusExampleTsx from "./_components/radius-example.tsx?raw";
...
<Demo tsx={radiusExampleTsx} css={radiusExampleCss}>
  <RadiusExample client:load />
</Demo>
